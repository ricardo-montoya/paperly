...
We provide different docker-compose.yml files under [this directory](https://github.com/ricardo-montoya/paperly/tree/master/docker-compose). Here are some examples.
...
```bash
git clone https://github.com/ricardo-montoya/paperly-seed
cd nocodb-seed
npm install
npm start
```
