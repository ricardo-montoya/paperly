...
- Available since [0.81.1](https://github.com/ricardo-montoya/paperly/releases/tag/0.81.1)

## How to share the base with read only access ?

- Either you can invite by email with 'viewer' access control
- Share the base with publicly accessible link. Available since [0.82.0](https://github.com/ricardo-montoya/paperly/releases/tag/0.82.0) 
